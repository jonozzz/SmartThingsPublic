...
preferences {
    page(name: "mainPage", title: "Install Video Camera", install: true, uninstall:true) {
        ...
        section("Add a Camera") {
            ...
            ["rtsp://user:password@[ipaddress]/Streaming/Channels/1":"hikvision"], //hikvision
            ["http://[ipaddress]:[port]/mjpeg.cgi?user=user&password=password&channel=1.mjpeg":"dlink"], //dlink 932l
            ["http://user:password@[ipaddress]/nphMotionJpeg?Resolution=640x480&Quality=Standard":"panasonic"], //panasonic bl-140c
            ["rtsp://admin:smart123@jono.uk.to:9554/onvif/profile5/media.smp":"samsung"], //samsung HD
            ["rtsp://admin:smart123@jono.uk.to:9555/cam/realmonitor?channel=1&subtype=0":"amcrest"] //amcrest HD
